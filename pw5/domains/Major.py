...
class Main:
    ...
    def Output(self):
        ...
        for i in range(self.__nos):
            ...
            self.screen.addstr(i * 3, 0, "*Student " + str(self.__Stu_list.getName(i)) + ": ")
            self.screen.addstr(i * 3 + 1, 0, "GPA: " + self.NumToLetPoint(math.floor(self.GPACalculator(self.__Cou_list, self.__noc, self.__nos, i))))
            self.screen.addstr(i * 3 + 2, 0, "WAM: " + str(math.floor(self.WAMCalculator(self.__Cou_list, self.__noc, self.__nos, i))))
        self.screen.getch()
        self.screen.clear()
